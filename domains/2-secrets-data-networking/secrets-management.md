...
**Resources:**
- [Vault seal/unseal concepts](https://developer.hashicorp.com/vault/docs/concepts/seal) `[depth]` (~15 min)
- [Integrated storage (Raft) backend](https://developer.hashicorp.com/vault/docs/configuration/storage/raft) `[depth]` (~15 min)
- [Auto-unseal with Transit](https://developer.hashicorp.com/vault/tutorials/auto-unseal/autounseal-transit) `[depth]` (~20 min)
- [`vault operator init` / Shamir key shares](https://developer.hashicorp.com/vault/docs/commands/operator/init) `[depth]` (~10 min)
- [Vault production hardening guide](https://developer.hashicorp.com/vault/tutorials/operations/production-hardening) `[depth]` (~25 min)
...
**Resources:**
- [Vault policies concept](https://developer.hashicorp.com/vault/docs/concepts/policies) `[required-for-lab]` (~20 min)
- [Kubernetes auth method](https://developer.hashicorp.com/vault/docs/auth/kubernetes) `[depth]` (~15 min)
- [AppRole auth method (machine auth)](https://developer.hashicorp.com/vault/docs/auth/approle) `[depth]` (~15 min)
- [Vault tokens & the token concept](https://developer.hashicorp.com/vault/docs/concepts/tokens) `[depth]` (~15 min)
- [Policies tutorial (capabilities & least privilege)](https://developer.hashicorp.com/vault/tutorials/policies/policies) `[depth]` (~20 min)
...
**Resources:**
- [Vault leases, renewal & revocation](https://developer.hashicorp.com/vault/docs/concepts/lease) `[depth]` (~15 min)
- [Database secrets engine](https://developer.hashicorp.com/vault/docs/secrets/databases) `[depth]` (~20 min)
- [Dynamic secrets tutorial (PostgreSQL)](https://developer.hashicorp.com/vault/tutorials/db-credentials/database-secrets) `[depth]` (~20 min)
- [Your first dynamic secret (intro)](https://developer.hashicorp.com/vault/tutorials/get-started/understand-dynamic-secrets) `[depth]` (~10 min)
...
**Resources:**
- [Database root credential rotation](https://developer.hashicorp.com/vault/docs/secrets/databases#rotate-credentials) `[depth]` (~10 min)
- [KV v2 versioned secrets](https://developer.hashicorp.com/vault/docs/secrets/kv/kv-v2) `[depth]` (~15 min)
- [Database static roles & scheduled rotation](https://developer.hashicorp.com/vault/tutorials/db-credentials/database-creds-rotation) `[depth]` (~20 min)
- [KV v2 API — versioning & rollback](https://developer.hashicorp.com/vault/api-docs/secret/kv/kv-v2) `[depth]` (~10 min)
...
**Resources:**
- [Vault Agent Injector](https://developer.hashicorp.com/vault/docs/platform/k8s/injector) `[depth]` (~20 min)
- [Injector annotations reference](https://developer.hashicorp.com/vault/docs/platform/k8s/injector/annotations) `[depth]` (~10 min)
- [Secrets Store CSI provider for Vault](https://developer.hashicorp.com/vault/docs/platform/k8s/csi) `[depth]` (~15 min)
- [Kubernetes Secrets Store CSI Driver — Concepts (how it works)](https://secrets-store-csi-driver.sigs.k8s.io/concepts#how-it-works) `[depth]` (~15 min)
- [Vault Secrets Operator (native CRD sync)](https://developer.hashicorp.com/vault/docs/platform/k8s/vso) `[depth]` (~15 min)
...
**Resources:**
- [Vault audit devices](https://developer.hashicorp.com/vault/docs/audit) `[depth]` (~15 min)
- [File audit device](https://developer.hashicorp.com/vault/docs/audit/file) `[depth]` (~10 min)
- [Syslog audit device](https://developer.hashicorp.com/vault/docs/audit/syslog) `[depth]` (~10 min)
- [Blocked audit devices & fail-closed behavior](https://developer.hashicorp.com/vault/docs/concepts/audit) `[depth]` (~15 min)
- [Vault monitoring & telemetry](https://developer.hashicorp.com/vault/tutorials/monitoring/monitor-telemetry-audit-splunk) `[depth]` (~20 min)
