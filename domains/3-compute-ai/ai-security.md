...
**Retrieval-Augmented Generation** grounds the model in your documents: a query is embedded, the vector store returns the most relevant chunks, and those chunks are stuffed into the prompt as context. This is powerful and is where most enterprise LLM data exposure happens. The security failure modes:
