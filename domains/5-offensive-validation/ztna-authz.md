...
## Standards
Offense: authz-bypass attempts (mapped to ATT&CK T1078 Valid Accounts / T1021 Remote Services where relevant). Defense: **NIST SP 800-207 / 207A** PEP enforcement; **[CISA ZTMM v2.0](https://www.cisa.gov/zero-trust-maturity-model)** "continually verify." Close the loop with the D4 SIEM so denials are observable. `[depth]`
