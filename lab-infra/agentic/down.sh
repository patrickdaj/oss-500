#!/usr/bin/env bash
# Tear down the Agentic Zero Trust stack. Leaves reused components (Keycloak/SPIRE/Ollama) alone.
set -euo pipefail
NS=oss500-apps
...
echo "==> Done. Reused components (Keycloak/SPIRE from lab-infra/identity, Ollama from lab-infra/ai) left running."
