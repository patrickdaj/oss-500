...
pipx run garak==0.15.1 --model_type rest -G ../lab-infra/offense/localhost-ollama.json --probes dan,promptinject,leakreplay

# Part B — identical probes against the NeMo-fronted gateway
pipx run garak==0.15.1 --model_type rest -G <gateway-config>.json --probes dan,promptinject,leakreplay
```
